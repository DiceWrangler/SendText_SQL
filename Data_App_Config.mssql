...
insert into App_Config(AppCon_App_Name, AppCon_Config_Name, AppCon_Config_Value) values ('SendText', 'Output', 'Send')  -- Send | Draft
insert into App_Config(AppCon_App_Name, AppCon_Config_Name, AppCon_Config_Value) values ('SendText', 'Process', 'All')  -- All | First
go
